...
function setup() {
	...
	var ball_options = {
	  ...
	  ball1 = Bodies.circle(320,380,30,ball_options);
	  World.add(world,ball1);
	
	  ball2= Bodies.circle( 360,380, 30,ball_options);
	  World.add(world,ball2);

	  ball3= Bodies.circle(400,380, 30,ball_options);
	  World.add(world,ball3);

	  ball4= Bodies.circle(440,380,30,ball_options);
	  World.add(world,ball4);

	  ball5= Bodies.circle( 480,380,30 ,ball_options);
...
function keyPressed()
{
  if(keyCode==UP_ARROW)
    {
		Matter.Body.applyForce(ball1,ball1.position,{x:20,y:-45}) //Matter.Body.applyForce(ball1,{x:0,y:0},{x:0.05,y:0});
    }
}
